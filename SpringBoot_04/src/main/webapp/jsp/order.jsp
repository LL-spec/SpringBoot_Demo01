            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">订单管理页面</h4>
                                <p class="category">这是对订单的管理及操作</p>
                            </div>
                            <div class="col-md-12">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-content" style="display: block;">
                                        <div class="row">
                                            <form action="javascript:loadOrders(currentPage)" method="post">
                                                <div class="col-md-3 m-b-xs">
                                                    <input id="selectByUname" name="uname" placeholder="用户名" class="form-control" type="text"/>
                                                </div>
                                                <div class="col-md-3 m-b-xs">
                                                    <input id="selectByCname" name="cname" placeholder="课程名称" class="form-control" type="text"/>
                                                </div>
...
<script type="text/javascript">
    ...
    function loadOrders(page) {
        ...
        var pageIndex = page;
        var pageSize = 10;
        var name = $("#selectByUname").val();
        var uname = name.length !== 0 ? name : "%";
        var cname = $("#selectByCname").val();
        $.ajax({
            url: "findAllDingdan",
            data:{
                pageIndex:page,
            ...
            success: function (results) {
                ...
                for (let i = 0; i < results.rows.length; i++) {
                    ...
                    $("#orderList").append(
                        ...
                        "<td>" + cdetail + "</td>" +
                        "<td>\n" +
                        "<button type='button' onclick='update(\"" + did + "\",\"" + uid + "\",\"" + uname + "\",\"" + cid + "\",\"" + cname + "\",\"" + cdetail + "\")' title='修改'><i class='fa fa-edit text-navy'></i></button>\n" +
                        "&nbsp;&nbsp;&nbsp;&nbsp;" +
                        "<button onclick='del(\"" + did + "\")'  title='删除'><i class='fa fa-trash-o text-navy'></i></button>\n" +
                        "</td>" +
                        "</tr>"
                    );
