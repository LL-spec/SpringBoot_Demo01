...
<%--        </div>--%>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="tohight?ctype=大学">大学</a>
                </li>
            ...
            $.ajax({
                ...
                success: function (results) {
                    ...
                    if(name=="数学"){
                        ...
                        $("#jisuanji").replaceWith(" <div class='row' id='jisuanji'></div>")
                        cidname="jisuanji";
                    }else {
                    ...
                    $("#"+cidname).append("<div class=\"col-12\" style='display: inline-block' >\n" +
                        ...
                        "<a style='float: right;' href='toprimaryall?ctype=大学&cname="+name+"'>更多<span>>></span></a>"+
                        "                </div>");
