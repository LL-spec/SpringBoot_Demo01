...
<main>
    <section class="menu section-padding">
        <div class="container">
            ...
            <div class="col-md-12">
                <form class="form-inline"  action="javascript:loadsuper(currentPage)" method="post">
    ...
    function loadsuper(page) {
        ...
        $.ajax({
            ...
            success:function (results){
                ...
                $("#jingpinkecheng").append("  <div class=\"col-12\">\n" +
                    "                    <h2 class=\"text-center mb-lg-5 mb-4\">所有精品课程</h2>\n" +
                    "                </div>")
