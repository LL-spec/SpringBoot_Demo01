...
<%--        </div>--%>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="toprimary?ctype=小学">小学</a>
                </li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-10 col-12 mx-auto">
                    <h1 class="text-white">我们的小学</h1>

                    <strong class="text-white">在时间里面,我们什么也不能留下。包括痛苦,快乐,和生命。</strong>
                </div>
            ...
            $.ajax({
                ...
                success: function (results) {
                    ...
                    $("#"+cidname).append("<div class=\"col-12\" style='display: inline-block' >\n" +
                        ...
                        "<a style='float: right;' href='toprimaryall?ctype=小学&cname="+name+"'>更多<span>>></span></a>"+
                        "                </div>");
                    ...
                    for (var i = 0; i < results.length; i++) {
                        ...
                        $("#"+cidname).append("<div class=\"col-lg-4 col-md-6 col-12\">\n" +
                            "                    <div class=\"menu-thumb\">\n" +
