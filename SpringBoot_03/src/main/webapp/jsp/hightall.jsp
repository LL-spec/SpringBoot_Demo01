...
<script>
    ...
    function loadAll(page,cname,ctype) {
        ...
        $.ajax({
            ...
            success:function (results){
                ...
                // console.log(results)
                $("#course").replaceWith("<div class='row' id='course'> </div>");
                $("#course").append("  <div class=\"col-12\">\n" +
                    "                    <h2 class=\"text-center mb-lg-5 mb-4\">所有"+type+name+"课程</h2>\n" +
                    "                </div>")
                for (var i = 0; i < results.rows.length; i++) {
                    ...
                    $("#course").append("                <div class=\"col-lg-4 col-md-6 col-12\">\n" +
                        "                    <div class=\"menu-thumb\">\n" +
                        "                        <div class=\"menu-image-wrap\">\n" +
    ...
    function goToPage(n,cname,ctype){
        loadAll(n,cname,ctype);
    }
    ...
    loadAll(currentPage,cname,ctype);
</script>
</body>
</html>
